...
import com.x.edgegateway.client.domain.ndp.card.CardIssuerBuilders;
import com.x.edgegateway.client.domain.ndp.dc.DoorControlCmdBuilders;
import com.x.edgegateway.client.domain.ndp.ec.ElevatorControlCmdBuilders;
import com.x.edgegateway.client.domain.ndp.energy.EnergyCmdBuilders;
import com.x.edgegateway.client.domain.ndp.firecontrol.FireControlCmdBuilders;
import com.x.edgegateway.client.domain.ndp.gw.GateWayCmdBuilders;
import com.x.edgegateway.client.domain.ndp.gw.devicerelation.DeviceRelationCmdBuilders;
import com.x.edgegateway.client.domain.ndp.intrusion.IntrusionControlCmdBuilders;
import com.x.edgegateway.client.domain.ndp.intrusion.IntrusionPointCmdBuilders;
import com.x.edgegateway.client.domain.ndp.light.LightControlCmdBuilders;
import com.x.edgegateway.client.domain.ndp.log.upload.DeviceLogCmdBuilders;
import com.x.edgegateway.client.domain.ndp.nvr.NvrCmdBuilder;
import com.x.edgegateway.client.domain.ndp.ota.DeviceOtaCmdBuilders;
import com.x.edgegateway.client.domain.ndp.pa.ParkingAreaCmdBuilders;
import com.x.edgegateway.client.domain.ndp.virtual.VirtualCmdBuilders;
import com.x.edgegateway.client.domain.ndp.webcam.WebcamCmdBuilders;
