...
import com.x.arthas.client.domain.vo.product.ProductVO;
import com.x.atop.client.domain.api.ApiRequestDO;
import com.x.atop.client.domain.common.AtopResult;
import com.x.edgegateway.atop.device.IEGAtopService;
import com.x.edgegateway.atop.device.impl.strategy.IDeviceReport;
import com.x.edgegateway.atop.device.impl.strategy.StrategyFactoryContext;
import com.x.edgegateway.atop.model.request.GatewayActiveRequest;
...
import com.x.edgegateway.client.IBridgeService;
import com.x.edgegateway.client.common.PageResult;
import com.x.edgegateway.client.common.Paging;
import com.x.edgegateway.client.common.ServiceResult;
import com.x.edgegateway.client.common.ServiceResultCode;
import com.x.edgegateway.client.domain.bridge.request.FaceDetectRequest;
import com.x.edgegateway.client.domain.bridge.vo.FaceDetectVO;
import com.x.edgegateway.client.domain.cmd.IssueDataCmdResponseVO;
import com.x.edgegateway.client.domain.device.DeviceRequest;
import com.x.edgegateway.client.netscheme.domain.constants.NetSchemeTypeEnum;
import com.x.edgegateway.common.utils.HttpUtils;
import com.x.edgegateway.core.device.domain.DeviceQuery;
import com.x.edgegateway.integration.service.arthas.IProductServiceClient;
import com.x.edgegateway.integration.service.arthas.ISchemaDataPointServiceClient;
import com.x.edgegateway.integration.service.athena.IDeviceMServiceClient;
import com.x.edgegateway.integration.service.basic.IShortUrlServiceClient;
...
import com.x.edgegateway.manager.base.utils.PagingUtils;
import com.x.edgegateway.manager.cmdissue.domain.IssueDataCmdResultDTO;
import com.x.edgegateway.manager.cos.model.FileDownloadDataDTO;
import com.x.edgegateway.manager.device.IDeviceManager;
import com.x.edgegateway.manager.device.IGatewayManager;
import com.x.edgegateway.manager.device.domain.DeviceDTO;
import com.x.edgegateway.manager.device.domain.GatewayActiveDTO;
...
import com.x.edgegateway.shared.service.cos.ICosSharedService;
import com.x.edgegateway.shared.service.cos.model.UploadToken;
import com.x.edgegateway.shared.service.device.IDeviceActiveSharedService;
import com.x.edgegateway.shared.service.device.IGatewaySharedService;
import com.x.edgegateway.shared.service.device.model.DeviceReportRequest;
import com.x.smart.client.domain.device.vo.GatewayCache;
...
public class EGAtopService implements IEGAtopService {
    ...
    private static final String ALG_URL = "https://ai.x-inc.top:7799/cv/throwning-object/x-ai/test/upload";
